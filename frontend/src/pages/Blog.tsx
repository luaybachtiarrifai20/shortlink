  ...
  return (
    <div className="pt-32 pb-20 px-4 min-h-screen">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-2xl sm:text-4xl font-bold mb-6 sm:mb-8">Blog & Updates</h1>
        
        <div className="grid grid-cols-1 gap-8">
          {blogPosts.map((post) => (
            <article key={post.id} className="glass p-5 sm:p-8 rounded-3xl hover:border-primary-500/50 transition-colors flex flex-col items-start">

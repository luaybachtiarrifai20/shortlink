    ...
    <div className="pt-32 pb-20 px-4 min-h-screen">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="glass p-5 sm:p-8 rounded-3xl space-y-4 sm:space-y-6 text-sm sm:text-base text-slate-300 leading-relaxed">
          ...
          <h2 className="text-base sm:text-2xl font-bold text-white mt-6 sm:mt-8 mb-3 sm:mb-4">1. Information We Collect</h2>
          <p>
          ...
          <h2 className="text-base sm:text-2xl font-bold text-white mt-6 sm:mt-8 mb-3 sm:mb-4">2. How We Use Your Information</h2>
          ...
          <h2 className="text-base sm:text-2xl font-bold text-white mt-6 sm:mt-8 mb-3 sm:mb-4">3. Data Security</h2>
          <p>
          ...
          <h2 className="text-base sm:text-2xl font-bold text-white mt-6 sm:mt-8 mb-3 sm:mb-4">4. Third-Party Links</h2>
          <p>
          ...
          <h2 className="text-base sm:text-2xl font-bold text-white mt-6 sm:mt-8 mb-3 sm:mb-4">5. Contact Us</h2>
          <p>
